    ...
    <li class="thread__item">
      ...
      <ul class="thread__body">
        <li class="comment__item">
          <span class="comment__item__content">
            <?php
            if (! empty($thread->comment)) {
              echo h($thread->comment);
            }
            ?>
          </span>
        </li>
        ...
        ?>
          <li class="comment__item">
            <img src="uploads/<?php echo ($thread->image); ?>" width="200" height="200">
          </li>
        <?php endif; ?>
      </ul>
      <div class="operation">
        <?php
        if (isset($_SESSION['me']['id']) && $_SESSION['me']['id'] === $thread->user_id):
        ?>
