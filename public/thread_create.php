...
<form action="" method="post" class="form-group thread_form" id="new_thread" enctype="multipart/form-data">
  <div class="form-group">
    <label>タイトル</label>
    <input type="text" name="title" id="title" class="form-control" value="<?php echo isset($_POST['title']) ? h($_POST['title']) : ''; ?>">
    <p id="err1" class="err"></p>
  </div>
  <div class="form-group">
    <label>コメント</label>
    <textarea type="text" name="comment" id="comment" class="form-control"><?php echo isset($_POST['comment']) ? h($_POST['comment']) : ''; ?></textarea>
